        ...
        <div className="flex flex-wrap ">
          <div className="w-full lg:w-1/2">
            <div className="flex flex-col items-center lg:items-start">
              ...
              >
                <HyperText
                  className="pb-8 text-4xl sm:text-6xl md:text-6xl font-thin tracking-tight lg:pt-10"
              ...
              <motion.span
                ...
                initial="hidden"
                animate="visible"
                className="bg-gradient-to-r from-pink-400 via-slate-200 to-purple-500 inline-block text-4xl sm:text-5xl md:text-4xl tracking-tight text-transparent bg-clip-text"
              >
